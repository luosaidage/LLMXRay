...
本项目严格参考 [功能设计.md](file:///c:/Users/sai/Codex/plan/LLM-XRay/功能设计.md) 和 [参考项目.md](file:///c:/Users/sai/Codex/plan/LLM-XRay/参考项目.md) 进行开发。以下是当前功能的实现进度对照表：
...
### 2. 运行后端服务
```bash
# 方式一：直接运行后端脚本 (默认端口 10001)
python backend/main.py

# 方式二：使用 uvicorn 运行
python -m uvicorn backend.main:app --host 127.0.0.1 --port 10001 --reload
```
